...
func TestFanOutClonesParallel(t *testing.T) {
	...
	start := time.Now()
	if err := fanOutClones(context.Background(), restore, "tmpl", clones); err != nil {
		t.Fatal(err)
	}
...
func TestFanOutClonesPropagatesErrors(t *testing.T) {
	...
	err := fanOutClones(context.Background(), restore, "tmpl", []string{"a", "b", "c"})
...
func TestFanOutClonesEmpty(t *testing.T) {
	...
	if err := fanOutClones(context.Background(), restore, "tmpl", nil); err != nil {
		t.Fatal(err)
	}
	if called {
